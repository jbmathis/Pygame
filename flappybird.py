...
def load_images():
    ...
    def load_image(img_file_name):
        ...
        img_file_name: The file name (including its extension, e.g.
            '.bmp') of the required image, without a file path.
        """
    ...
    return {'background': load_image('background.bmp'),
            'pipe-end': load_image('pipe_end.bmp'),
            'pipe-body': load_image('pipe_body.bmp'),
            # images for animating the flapping bird -- animated GIFs are
            # not supported in pygame
            'bird-wingup': load_image('bird_wing_up.bmp'),
            'bird-wingdown': load_image('bird_wing_down.bmp')}
